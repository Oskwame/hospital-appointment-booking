...
export function OverviewTab() {
    ...
    const quickActions = [
        { label: "Create User", icon: UserPlus, href: "/users/create" },
        { label: "Add Doctor", icon: Users, href: "/doctors/create" },
        { label: "New Service", icon: CalendarPlus, href: "/services/create" },
