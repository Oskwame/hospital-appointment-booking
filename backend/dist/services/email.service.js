...
exports.transporter = exports.sendAppointmentConfirmation = exports.sendOTP = void 0;
...
// ========================================
const sendOTP = async (email, code, expiryMinutes = 5) => {
    try {
...
// ========================================
const sendAppointmentConfirmation = async (email, name, date, time, doctorName, serviceName, appointmentId) => {
    try {
        const from = process.env.BREVO_FROM_EMAIL || '"Kasa Family Hospital" <noreply@kasahospital.com>';
        const info = await brevoTransporter.sendMail({
            from,
...
exports.transporter = brevoTransporter;
